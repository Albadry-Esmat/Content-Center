...
import { completeKnownProvider, listKnownProviderModels, listProviderAvailability } from '../provider-proxy'
...
export const aiRouter = router({
  ...
  listModels: protectedProcedure.input(z.object({ providerId })).query(({ input }) => listKnownProviderModels(input.providerId)),
