...
export default function Generator() {
  ...
  const foundationStatusLabel = foundationStatus === 'generating' ? 'Generating a draft…' : foundationStatus === 'success' ? 'AI draft · review required' : foundationStatus === 'warning' ? 'AI draft · warnings to review' : foundationStatus === 'cancelled' ? 'Draft generation cancelled' : foundationStatus === 'error' ? 'Draft generation failed' : 'Ready when you choose to generate'
