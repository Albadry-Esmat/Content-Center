...
export default function Generator() {
  ...
  async function generateFoundation() {
    ...
    try {
      ...
      if (controller.signal.aborted) {
        ...
        const message = error instanceof Error ? error.message : 'Foundation generation failed. Check the connection and retry.'
  ...
  const foundationProviderLabel = generationProfile.providerMode === 'local' ? 'Local provider · stays on this device' : 'Known provider · routed through the server proxy'
