...
import { loadCombinedPacks } from '../lib/content-storage'
...
export default function Workspace() {
  ...
  if (!isAuthenticated || !user) return <LocalWorkspace onCreate={() => setLocation('/generator')} onLibrary={() => setLocation('/saved')} />
